  ...
  render() {
    return (
      <div className="buttonPanel">
        <div>
          {this.renderButton('milky', 'AC', false, '#F8814A')}
          {this.renderButton('milky', '+/-', false, '#F8814A')}
          {this.renderButton('milky', '%', false, '#F8814A')}
          {this.renderButton('orange ops', '÷', false)}
        </div>
        <div>
          {this.renderButton('milky', '7', false, '#E0E0E0')}
          {this.renderButton('milky', '8', false, '#E0E0E0')}
          {this.renderButton('milky', '9', false, '#E0E0E0')}
          {this.renderButton('orange ops', 'x', false)}
        </div>
        <div>
        ...
        <div>
          ...
          {this.renderButton('orange enter', '=', false, '#EC3711')}
        </div>
      </div>
    );
  }
